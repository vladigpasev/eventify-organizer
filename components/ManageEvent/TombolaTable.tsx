...
// const TombolaTable = ({ eventId, isSeller, userUuid }: UserTableProps) => {
...
//         <h2 className="text-xl font-semibold mb-3">Билети за томбола</h2>
//       </div>
//       {isLoading ? <>Зареждане...</> :
//         <>
//           <div className="mb-4">
...
//               {totalTombolaTickets} Билети за томбола
//             </span>
//           </div>
//           <div className="mb-4">
//             <input
