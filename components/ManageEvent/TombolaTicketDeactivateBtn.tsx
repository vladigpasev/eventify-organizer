...
import { deactivateManualTicketTombola } from '@/server/events/tickets/generate';
//@ts-ignore
function TombolaTicketDeactivateBtn({ customerUuid, disabled }) {
    ...
    const deactivateTicket = async () => {
        try {
            setIsLoading(true);
            await deactivateManualTicketTombola(customerUuid);
...
export default TombolaTicketDeactivateBtn;