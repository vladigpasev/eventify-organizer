...
export async function sendMailToAllCustomers(data: any, start: number, batchSize: number) {
    ...
    try {
        ...
        const customersForEvent = await db.select({
            firstName: eventCustomers.firstname,
            lastName: eventCustomers.lastname,
            email: eventCustomers.email,
        })
            .from(eventCustomers)
            .where(eq(eventCustomers.eventUuid, validatedData.eventId))
            .execute();
        ...
        const getEventData = await db.select({
            ...
            .from(events)
            .where(eq(events.uuid, validatedData.eventId))
            .execute();
        ...
        if (userUuid != eventData.userUuid) {
            throw "Unauthorized";
        }
        ...
        for (const customer of batchCustomers) {
            let info = await transporter.sendMail({
                ...
                <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-bottom:5px;padding-top:20px"><h1 style="Margin:0;line-height:55px;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica, sans-serif;font-size:46px;font-style:normal;font-weight:bold;color:#333333">${validatedData.subject}</h1></td></tr></table></td></tr></table></td></tr> <tr><td align="left" style="padding:0;Margin:0;padding-top:20px;padding-left:20px;padding-right:20px"><table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"><tr><td align="center" valign="top" style="padding:0;Margin:0;width:560px"><table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"><tr>
                <td align="left" style="padding:0;Margin:0"><div style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica, sans-serif;line-height:30px;color:#333333;font-size:20px">Здравей, ${customer.firstName} ${customer.lastName}!<br></div> <div style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica, sans-serif;line-height:30px;color:#333333;font-size:20px">${validatedData.emailText}</div></td></tr></table></td></tr></table></td></tr></table></td></tr></table> <table cellpadding="0" cellspacing="0" class="es-content" align="center" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%"><tr>
        ...
        throw { success: false, message: 'Failed to send emails' };
    }
}
