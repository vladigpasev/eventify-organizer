    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
            ...
            <div className="bg-white shadow-xl rounded-lg p-6 max-w-sm w-full">
                <h1 className="text-2xl font-semibold text-gray-800">Потвърдете имейла си</h1>
                {isVerificationSent ? (
                    <p className="text-gray-600 mt-2">Връзката за проверка вече е изпратена на имейла ви. Ако нямате такава, моля, свържете се с поддръжката на Eventify или опитайте да я изпратите отново.</p>
                ) : (
